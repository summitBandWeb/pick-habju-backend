...
class MockCrawler(BaseCrawler):
    ...
    async def check_availability(
        self, date: str, hour_slots: List[str], rooms: List[RoomDetail]
    ) -> List[RoomResult]:
...
def test_get_availability_api():
    ...
    with patch(
        ...
        return_value=mock_room_details,
    ):
...
def test_get_availability_api_with_crawler_error():
    ...
    def override_with_error():
        # "naver" -> ErrorCrawler
        # "dream" -> NormalCrawler
        return {"naver": ErrorCrawler(), "dream": normal_crawler}
    ...
    try:
        ...
        # Validation Bypass
        with patch(
            "app.validate.request_validator.validate_room_detail_list"
